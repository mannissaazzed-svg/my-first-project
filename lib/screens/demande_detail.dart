...
class MissionDetails extends StatelessWidget {
  ...
  const MissionDetails({super.key, required this.mission});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRow("Agent", mission.agentName),
              _buildRow("Lieu", mission.LIEU),
              _buildRow("Dates", "${mission.DateDepart} → ${mission.DateRetour}"),
              _buildRow("Transport", mission.Mode_Transport),
              _buildRow("Parcours", mission.Parcours),
              const SizedBox(height: 25),
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Mission approuvée")),
                      );
                      Navigator.pop(context);
                    },
                    style: ElevatedButton.styleFrom(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Mission rejetée")),
                      );
                      Navigator.pop(context);
                    },
                    style: ElevatedButton.styleFrom(
